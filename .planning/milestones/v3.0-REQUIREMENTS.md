# Requirements Archive: v3.0 Tool Reviews, Glossary, and Infrastructure
...
- [x] **NEWS-01**: Cloudflare Worker for signup (worker/subscribe.js, clone RevOps pattern)
- [x] **NEWS-02**: Worker deployment config (worker/wrangler.toml)
- [x] **NEWS-03**: Weekly email generator script (scripts/generate_weekly_email.py)
- [x] **NEWS-04**: Cron script for automated Monday sends (scripts/send_weekly_email.sh)
