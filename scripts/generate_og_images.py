...
# Playwright-based OG image generator for GTME Pulse.
...
def generate_og_images(pages_data, output_dir, templates_dir, skip=False):
    ...
    with sync_playwright() as p:
        ...
        for i, page_info in enumerate(pages_data):
            ...
            title = html_module.escape(page_info.get("title", "GTME Pulse"))
    ...
    test_pages = [
        {
            "rel_path": "index.html",
            "title": "GTME Pulse",
            "subtitle": "Career intelligence for GTM Engineers",
            "template": "og-default",
        ...
        {
            "rel_path": "tools/clay-review/index.html",
            "title": "Clay Review 2026",
            "subtitle": "Data Enrichment & Orchestration",
            "template": "og-tool",
            "og_filename": "tools-clay-review.png",
            "category": "TOOL REVIEW",
        },
        {
            "rel_path": "glossary/data-enrichment/index.html",
            "title": "What is Data Enrichment?",
            "subtitle": "Clear definition with real examples for GTM Engineers",
            "template": "og-glossary",
            "og_filename": "glossary-data-enrichment.png",
        },
        {
            "rel_path": "insights/job-market/index.html",
            "title": "GTM Engineer Job Market Analysis",
            "subtitle": "Weekly job market data and hiring trends",
            "template": "og-article",
            "og_filename": "insights-job-market.png",
        },
    ]
